...
#Take in dataframe of each doctor's ranking of hospitals and a list of capacities of the hospitals and output an adjusted square ranks numpy matrix and hospital names
